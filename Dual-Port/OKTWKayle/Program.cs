...
namespace OneKeyToWin_AIO_Sebby.Champions
{
    class Kayle
    {
        ...
        public static void LoadOKTW()
        {
            ...
            wMenu.Add("Wally" + enemy.ChampionName, new CheckBox("W ally : " + enemy.ChampionName));
        ...
        private static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            if (Program.LagFree(3) && E.IsReady() && getCheckBoxItem(eMenu, "autoE"))
                LogicE();
            if (Program.LagFree(4) && Q.IsReady() && getCheckBoxItem(qMenu, "autoQ"))
                LogicQ();
        }
        ...
        private static void LogicE()
        {
            if (Program.Combo && Player.Mana > WMANA + EMANA && Player.CountEnemiesInRange(700) > 0)
                ...
                E.Cast();
            else if (Program.LaneClear && getCheckBoxItem(farmMenu, "farmE") && Player.Mana > WMANA + EMANA + QMANA && FarmE())
                E.Cast();
        }
