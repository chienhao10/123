...
namespace OneKeyToWin_AIO_Sebby
{
    class KogMaw
    {
        ...
        public static void LoadOKTW()
        {
            ...
            wMenu.Add("autoE", new CheckBox("Auto E", true));
            wMenu.Add("HarrasE", new CheckBox("Harass E", true));
            wMenu.Add("AGC", new CheckBox("AntiGapcloserE", true));

            eMenu = Config.AddSubMenu("E Config");
            eMenu.Add("autoW", new CheckBox("Auto W", true));
            eMenu.Add("harasW", new CheckBox("Harass W on max range", true));
