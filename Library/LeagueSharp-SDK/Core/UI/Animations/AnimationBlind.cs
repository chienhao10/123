...
namespace LeagueSharp.SDK.Core.UI.Animations
{
    ...
    /// </summary>
    public class AnimationBlind : Animation
    {
        #region Fields
        ...
        public AnimationBlind(Mode mode, float duration, Rectangle defaultRect)
            : base(duration)
        {
            this.mode = mode;
        ...
        /// After start you can get the current value in <see cref="AnimationBlind.GetCurrentValue" /> method
        /// </summary>
